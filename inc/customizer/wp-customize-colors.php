	...
	function initialize( $wp_customize ) {
		...
		$wp_customize->add_section(
			...
			array(
				...
				'description' => sprintf( __( 'Color Customization for %1$s', 'zbauerarchitect' ), $theme->name ),
				'title'       => __( 'Colors', 'zbauerarchitect' ),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				...
				<p>' . __( 'Color customization for this theme is now available exclusively in the Full Site Editor Global Styles panel.<br><br>Featured Palettes can now be found in the Full Site Editor as Theme Variations.', 'zbauerarchitect' ) . '</p>
				</div>',
				'settings'    => array(),
