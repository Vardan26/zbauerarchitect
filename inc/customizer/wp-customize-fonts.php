...
class GlobalStylesFontsCustomizer {
	...
	function generate_deprecation_message() {
		return sprintf(
			__( 'Updating fonts for this theme is now even easier! Use the site editor to select and preview different font families. <a href="%s">More information.</a>', 'zbauerarchitect' ),
	...
	function init_deprecation_notice( $wp_customize ) {
		$wp_customize->add_section(
			...
			array(
				...
				'title'      => __( 'Fonts', 'zbauerarchitect' ),
			)
		);

		$wp_customize->add_control(
			$this->section_key . '-v1-zbauerarchitect-font-deprecation-notice',
			array(
				'type'        => 'hidden',
